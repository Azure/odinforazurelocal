...
- **Tests: Large Cluster & Scaling Tests**: Added comprehensive test suites for node-weight constants, large-cluster memory cap, conservative/aggressive auto-scale modes, large cluster node recommendations, and node preference verification
