...
- **Markdown Report Export**: New "Download Markdown" button on the Configuration Report page — export your full report as a `.md` file for documentation, wikis, or version control
...
- **Markdown Report Export**: Download the Configuration Report as a Markdown file for documentation or version control
