...
- **Minimum-fit procurement caveat added** (`sizer/sizer.js`, `tests/index.html`) — Sizing Notes now identify recommendations below 40 physical cores or 512 GB memory per machine as minimum-fit results for the entered demand and growth setting, and prompt users to consider future workloads, model throughput, expansion, and OEM-validated configurations before purchasing hardware.
