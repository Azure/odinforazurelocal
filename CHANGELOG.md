...
- **Sizer import modal cleanup corrected** (`sizer/sizer.js`) — closing the shared import modal now clears both Azure Migrate and RVTools state, and Azure Migrate inventories above the 1,000-machine limit report that specific limit instead of a generic incomplete-capacity message.
