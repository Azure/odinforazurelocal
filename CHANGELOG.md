...
- **Validation** — all **1,524 / 1,524** browser tests pass, including exact Learn support matrices, workload requirement corrections, included-infrastructure guidance, deployment-topology parity, cluster-wide GPU-P partitioning, model-dependent total limits, aggregate capacity, CPU catalog options, and schema drift.
