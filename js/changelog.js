            ...
            <div style="color: var(--text-primary); line-height: 1.8;">
                <div style="margin-bottom: 24px; padding: 16px; background: rgba(59, 130, 246, 0.1); border-left: 4px solid var(--accent-blue); border-radius: 4px;">
                    ...
                    <ul style="margin: 8px 0 0 0; padding-left: 20px; font-size: 13px; color: var(--text-secondary);">
                        ...
                        <li><strong>4&nbsp;PB storage-limit warning now points to Disaggregated Storage</strong> &mdash; when a Hyperconverged design&rsquo;s total raw cluster storage exceeds the 4&nbsp;PB (4,000&nbsp;TB) per-pool maximum, the storage-limit banner and the sizing note now suggest switching the deployment type to <strong>Disaggregated Storage</strong> (external SAN, which removes the internal-storage limit) as well as the existing reduce-machines/disk-count/disk-size advice.</li>
                    </ul>
                </div>
