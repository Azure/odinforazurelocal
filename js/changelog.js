            ...
            <div style="color: var(--text-primary); line-height: 1.8;">
                <div style="margin-bottom: 24px; padding: 16px; background: rgba(59, 130, 246, 0.1); border-left: 4px solid var(--accent-blue); border-radius: 4px;">
                    ...
                    <ul style="margin: 8px 0 0 0; padding-left: 20px; font-size: 13px; color: var(--text-secondary);">
                        ...
                        <li><strong>Sizer Estimated Power &mdash; Annual Energy (kWh/yr) + optional running cost</strong> &mdash; the <em>Estimated Power, Heat &amp; Rack Space</em> panel now shows an estimated yearly energy figure (total Watts run 24/7/365) and an optional <strong>Electricity Price (USD/kWh)</strong> box that estimates the annual running cost (with an &#9432; hover tip and currency-converter link), alongside the existing per-machine Watts, total Watts, and BTU/hr.</li>
