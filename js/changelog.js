            ...
            <div style="color: var(--text-primary); line-height: 1.8;">
                <div style="margin-bottom: 24px; padding: 16px; background: rgba(59, 130, 246, 0.1); border-left: 4px solid var(--accent-blue); border-radius: 4px;">
                    ...
                    <ul style="margin: 8px 0 0 0; padding-left: 20px; font-size: 13px; color: var(--text-secondary);">
                        ...
                        <li><strong>UX polish</strong> &mdash; the optional electricity-price annual cost in the <em>Estimated Power, Heat &amp; Rack Space per Instance</em> panel now shows a small grey <code>Cost:</code> label (matching the <code>Input:</code> label above it) so the value reads clearly as e.g. <em>Cost: 47,041/yr</em> instead of the bare <em>47,041/yr</em>. The <code>Cost:</code> label only appears when the price field is populated. Also added a small vertical gap between the <code>&#x1F4C8; Capacity Runway</code> collapsible and the <em>Azure Local Instance &mdash; Sizing Notes</em> block so the two cards no longer butt up against each other.</li>
                    </ul>
                </div>
