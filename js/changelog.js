            ...
            <div style="color: var(--text-primary); line-height: 1.8;">
                <div style="margin-bottom: 24px; padding: 16px; background: rgba(59, 130, 246, 0.1); border-left: 4px solid var(--accent-blue); border-radius: 4px;">
                    ...
                    <ul style="margin: 8px 0 0 0; padding-left: 20px; font-size: 13px; color: var(--text-secondary);">
                        ...
                        <li><strong>AUTO-scaled field state now survives F5 / Resume</strong> &mdash; the in-memory <code>_autoScaledFields</code> Set and <code>_disaggAutoUpgraded</code> guard were not persisted in the saved Sizer state, so after pressing <strong>F5</strong> and clicking <strong>Resume</strong>, every AUTO badge was lost (including the cluster-type badge required by the auto-downgrade). Symptom: removing a <strong>MANUAL</strong> override on <em>Memory</em> after Resume left the cluster stuck on Disaggregated, instead of dropping back to Hyperconverged like it did in the same session before F5. The saved state now carries <code>autoScaledFields</code> and <code>disaggAutoUpgraded</code>; Resume re-hydrates both before the next calculation, the AUTO badges reappear, and the symmetric auto-downgrade fires correctly. Schema updated; both fields are optional and backwards-compatible.</li>
