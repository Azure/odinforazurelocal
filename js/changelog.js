        ...
        <div style="background: var(--card-bg); border: 1px solid var(--glass-border); border-radius: 16px; padding: 20px; max-width: 700px; width: 100%; max-height: 90vh; overflow-y: auto; box-sizing: border-box;">
            ...
            <div style="color: var(--text-primary); line-height: 1.8;">
                <div style="margin-bottom: 24px; padding: 16px; background: rgba(59, 130, 246, 0.1); border-left: 4px solid var(--accent-blue); border-radius: 4px;">
                    ...
                    <p style="margin: 8px 0 0 0; font-size: 13px; color: var(--text-secondary);">Adds <strong>Foundry Local on Azure Local (Preview)</strong> and <strong>Edge RAG Preview, enabled by Azure Arc</strong> as two new top-level workload types in the Sizer, alongside Azure Local VMs, AKS Arc, and AVD. Foundry Local sizes per-replica model serving (Small SLM / Medium SLM / Large LLM / Custom + ONNX-GenAI or vLLM engine). Edge RAG sizes a turnkey 4-VM Retrieval Augmented Generation pipeline (LLM + embeddings + vector DB) in either GPU mode (4&nbsp;\u00d7 NC8_A2 / NC8_A16) or CPU mode, with vector-DB storage scaling from your document corpus size. Both workload types round-trip through JSON Export/Import, share URLs, the Designer hand-off, and Configuration Reports.</p>
                </div>
