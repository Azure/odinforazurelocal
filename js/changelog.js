        ...
        <div style="background: var(--card-bg); border: 1px solid var(--glass-border); border-radius: 16px; padding: 20px; max-width: 700px; width: 100%; max-height: 90vh; overflow-y: auto; box-sizing: border-box;">
            ...
            <div style="color: var(--text-primary); line-height: 1.8;">
                <div style="margin-bottom: 24px; padding: 16px; background: rgba(59, 130, 246, 0.1); border-left: 4px solid var(--accent-blue); border-radius: 4px;">
                    ...
                    <p style="margin: 8px 0 0 0; font-size: 13px; color: var(--text-secondary);">Adds the <strong>Microsoft 365 Local &mdash; Medium-Scale</strong> reference architecture to the <em>Microsoft Sovereign Private Clouds</em> page (Knowledge tab). The new option sits between Small-Scale (1 collapsed 3-node cluster) and Large-Scale (7 clusters): <strong>2 single-node Azure Local clusters hosting Exchange mailbox servers</strong>, plus <strong>1 three-node Azure Local cluster hosting Exchange Edge Transport, SharePoint, Skype for Business and SQL</strong> &mdash; 3 Azure Local clusters / 5 servers total. The on-screen SVG diagram, the per-purpose notes, and the PowerPoint export (overview pill + per-purpose Scale panel + diagram slide) all pick up the new variant automatically. Active Directory, Firewall, Load Balancer and the internal management network router remain infrastructure components on the management / compute networks &mdash; not separate Azure Local clusters. Storage is fixed at <strong>S2D (local)</strong> (same constraint as Small / Large). ESLint clean; HTML validation clean; full test suite passes.</p>
                </div>
