            ...
            <div style="color: var(--text-primary); line-height: 1.8;">
                <div style="margin-bottom: 24px; padding: 16px; background: rgba(59, 130, 246, 0.1); border-left: 4px solid var(--accent-blue); border-radius: 4px;">
                    ...
                    <ul style="margin: 8px 0 0 0; padding-left: 20px; font-size: 13px; color: var(--text-secondary);">
                        ...
                        <li><strong>Sizer &quot;Allow for Future Growth&quot; now defaults to 10&nbsp;% (recommended)</strong> &mdash; first-time visitors see a realistic sizing envelope instead of <em>No additional growth</em>. The dropdown shows an <strong>AUTO</strong> badge on fresh load so it's clear the 10&nbsp;% is a recommended default rather than a hidden adjustment, and any user change to the field &mdash; including switching back to <em>No additional growth</em> &mdash; replaces the AUTO badge with a <strong>MANUAL</strong> badge so an explicit &quot;no growth&quot; choice is preserved and visible. Restoring a previous Sizer session leaves the saved value untouched and shows no badge.</li>
