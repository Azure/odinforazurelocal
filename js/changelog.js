            ...
            <div style="color: var(--text-primary); line-height: 1.8;">
                ...
                <div style="margin-bottom: 24px; padding-bottom: 24px; border-bottom: 1px solid var(--glass-border);">
                    ...
                    <ul style="margin: 0; padding-left: 20px;">
                        ...
                        <li><strong>Two new stat tiles</strong> on the page-statistics bar (Designer, Sizer, and the new bar on the ToR Switch Configuration page) — <em>Switch Configs</em> and <em>QoS Audits</em> — surface the new counters next to the existing Visitors / Designs / Sizes / ARM Deployments tiles. The bar wraps onto a second row on common laptop widths so all six tiles fit without crowding.</li>
