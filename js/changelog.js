            ...
            <div style="color: var(--text-primary); line-height: 1.8;">
                ...
                <div style="margin-bottom: 24px; padding-bottom: 24px; border-bottom: 1px solid var(--glass-border);">
                    ...
                    <ul style="margin: 0; padding-left: 20px;">
                        ...
                        <li><strong>New “Workloads” slide in the PowerPoint export</strong> of the Configuration Report. When the report was started from the Sizer, the generated PPTX now includes a dedicated <em>Workloads</em> slide right after <em>Rack Configuration</em>, with one bullet per VM / AKS Arc / AVD workload plus a <em>Subtotal</em> sub-bullet (vCPUs · memory · storage). The slide is automatically skipped for non-Sizer reports.</li>
