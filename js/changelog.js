            ...
            <div style="color: var(--text-primary); line-height: 1.8;">
                <div style="margin-bottom: 24px; padding: 16px; background: rgba(59, 130, 246, 0.1); border-left: 4px solid var(--accent-blue); border-radius: 4px;">
                    ...
                    <ul style="margin: 8px 0 0 0; padding-left: 20px; font-size: 13px; color: var(--text-secondary);">
                        ...
                        <li><strong>Proxy-bypass reminder</strong> &mdash; when Private Endpoints are <em>Enabled</em>, an information box now appears below the service list: <em>&ldquo;When using a Proxy, you <strong>must</strong> add your Private Endpoints to the Proxy Bypass List &mdash; otherwise the traffic is routed through the proxy to the public endpoint, defeating the Private Endpoint,&rdquo;</em> linking to <a href="https://learn.microsoft.com/en-us/azure/azure-local/manage/configure-proxy-settings-23h2" target="_blank" rel="noopener">Configure proxy settings for Azure Local</a>.</li>
                    </ul>
                </div>
