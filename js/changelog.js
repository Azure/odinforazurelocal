        ...
        <div style="background: var(--card-bg); border: 1px solid var(--glass-border); border-radius: 16px; padding: 20px; max-width: 700px; width: 100%; max-height: 90vh; overflow-y: auto; box-sizing: border-box;">
            ...
            <div style="color: var(--text-primary); line-height: 1.8;">
                ...
                <div style="margin-bottom: 24px; padding-bottom: 24px; border-bottom: 1px solid var(--glass-border);">
                    <h4 style="color: var(--accent-purple); margin: 0 0 12px 0;">⚙️ Sizer: Intel® 6th Gen Xeon® Scalable Processor</h4>
                    <ul style="margin: 0; padding-left: 20px;">
                        <li><strong>Intel® 6th Gen Xeon® Scalable Processor:</strong> Added new CPU generation option to the Sizer — supports 8–172 cores, based on the <a href="https://azurelocalsolutions.azure.microsoft.com" target="_blank">Azure Local hardware catalog</a>.</li>
                        <li><strong>Updated Intel Default:</strong> Intel CPU default changed from 5th Gen Xeon Scalable (Emerald Rapids) to 6th Gen Xeon Scalable Processor.</li>
                    </ul>
                </div>
