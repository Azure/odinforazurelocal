        ...
        <div style="background: var(--card-bg); border: 1px solid var(--glass-border); border-radius: 16px; padding: 20px; max-width: 700px; width: 100%; max-height: 90vh; overflow-y: auto; box-sizing: border-box;">
            ...
            <div style="color: var(--text-primary); line-height: 1.8;">
                <div style="margin-bottom: 24px; padding: 16px; background: rgba(59, 130, 246, 0.1); border-left: 4px solid var(--accent-blue); border-radius: 4px;">
                    ...
                    <p style="margin: 8px 0 0 0; font-size: 13px; color: var(--text-secondary);">Documents ODIN's export/import format as machine-readable <strong>JSON Schemas</strong> and hardens the importers (<a href="https://github.com/Azure/odinforazurelocal/issues/237" target="_blank" rel="noopener noreferrer" style="color: var(--accent-blue);">issue #237</a>). The Designer and Sizer each get their own draft-07 schema so designs can be validated and automated offline. <em>In progress &mdash; planned scope below.</em></p>
                    <ul style="margin: 8px 0 0 0; padding-left: 20px; font-size: 13px; color: var(--text-secondary);">
                        <li><strong>Two JSON Schemas</strong> &mdash; one for the Designer export (<code>version</code> / <code>exportedAt</code> / <code>state</code>) and one for the Sizer export (<code>_meta</code> / <code>data</code>, with a <code>workloads</code> model keyed by workload type). Both forward-compatible and self-documenting.</li>
