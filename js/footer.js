...
(function() {
    ...
    const footerHtml = '🔒 Privacy: Your inputs, configurations and template data stay in your browser &mdash; nothing you type or import is transmitted externally.<br>'
        ...
        + '<a href="https://github.com/Azure/odinforazurelocal/blob/main/js/analytics.js" target="_blank" rel="noopener noreferrer" style="color:var(--accent-blue);">See analytics source</a>.';
