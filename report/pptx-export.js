...
(function() {
    ...
    function extractSizerSizingNotes() {
        ...
        const advisoryPrefix = 'Advisory - minimum-fit hardware:';
        const bullets = notes
            ...
            .slice(0, 24)
            .map(function(note) {
                if (!note.startsWith(advisoryPrefix)) return { text: note, lvl: 1 };
                return {
                    text: note,
                    lvl: 1,
                    runs: [
                        { text: 'Advisory', color: 'B45309', bold: true },
                        { text: advisoryPrefix.slice('Advisory'.length), bold: true },
                        { text: note.slice(advisoryPrefix.length) }
                    ]
                };
            });
