...
- **fast-uri**: NEVER allow `fast-uri` to regress below version **4.1.2**. Version 4.1.1 is affected by host confusion via a backslash authority introducer (GHSA-7p8r-x3mc-p8w7 / CVE-2026-18446). Pulled in transitively through HTML Validate and Stylelint; maintain the `">=4.1.2"` override.
